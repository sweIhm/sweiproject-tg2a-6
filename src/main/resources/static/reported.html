...
<body onload="angular.element(document.querySelector('#menu-container')).scope().getView();">
	...
	<div ng-controller="ActivityCtrl">
		...
		<div id="menu-container" ng-controller="MenuCtrl">
			...
			<div id="menu">
				<!--<div class="menu-item" id="menu-item-map" onclick="angular.element(this).scope().showMap1()">Map MUAS (sprint2)</div>
				<div class="menu-item" id="menu-item-map2"onclick="angular.element(this).scope().showMap2()">Map CalPoly (sprint2)</div>
				-->
				<div class="menu-item">Reported Activities</div>
		...
		<div>
			...
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBsrHbQSVfjOxEgQ7btb-1yM6PpHX-gmEM&callback=initializeMaps" async defer></script>
		</div>
